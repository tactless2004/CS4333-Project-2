...
def test_sliding_window():
    ...
    #region init sender
    s.set_filename(os.path.join(os.getcwd(), "test_files", "50mb.bin"))
    s.set_mode(1)
    ...
    r.set_filename(os.path.join(os.getcwd(), "test_files", "50mb_copy.bin"))
    ...
    with open(os.path.join(os.getcwd(), "test_files", "50mb.bin"), "rb") as f:
        hasher1.update(f.read())
        hash1 = hasher1.hexdigest()

    with open(os.path.join(os.getcwd(), "test_files", "50mb_copy.bin"), "rb") as f:
